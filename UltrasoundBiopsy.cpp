...
// 唯一的一个 CUltrasoundBiopsyApp 对象

CUltrasoundBiopsyApp theApp;


// CUltrasoundBiopsyApp 初始化
...
BOOL CUltrasoundBiopsyApp::InitInstance()
{
	...
	SetRegistryKey(_T("曼翔(德国)医疗器械有限公司"));
...
// CUltrasoundBiopsyApp 自定义加载/保存方法
